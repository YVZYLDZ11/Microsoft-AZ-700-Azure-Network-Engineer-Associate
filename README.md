...
This repository documents my preparation for the **Microsoft Certified: Azure Network Engineer Associate (AZ-700)** exam. It serves as a comprehensive collection of hands-on labs, architectural designs, scripts, and study notes related to Azure Networking.

## 🎯 Learning Objectives & Lab Progress
Below is the list of key networking topics and labs covering the official exam objectives.

### 🔌 Module 1: Design and Implement Core Networking Infrastructure
- [ ] Design and Implement Virtual Networks (VNet)
- [ ] Configure VNet Peering & Service Chaining
- [ ] Manage IP Addressing (Public/Private) & Subnetting
- [ ] Configure Azure DNS (Public, Private Zones & Resolver)

### 🌉 Module 2: Design and Implement Connectivity Services
- [ ] Configure Site-to-Site (S2S) VPN & Point-to-Site (P2S) VPN
- [ ] Implement VNet-to-VNet Connectivity
...
- [ ] Configure Azure Load Balancer (Public & Internal)
- [ ] Implement Azure Application Gateway (WAF)
